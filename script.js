...
function addCount(directionKey, vehicleType) {
  ...
  const laneCount =
    document.getElementById("laneCount").value;
...
function exportCSV() {
  ...
  csv +=
    "Timestamp,ISO Time,Site,Client / Project,Road,Number of Lanes,Lane / Movement Type,Direction,Vehicle Type\n";
